    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="index.php?controller=accessory&action=edit&id=<?php echo $value['id']; ?>">Edit</a>
                    <a onclick="return confirm('Confirm deleting?')" href="index.php?controller=accessory&action=delete&id=<?php echo $value['id']; ?>" title="Delete">Delete</a>
                </td>
            </tr>
            <?php
            }
