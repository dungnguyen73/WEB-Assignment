...
<head>
    ...
    <title>Adding accessory</title>
</head>
<body>
    <div class="container-fluid" id="accessory-container">
        <h3>Add new accessory</h3>
        <a href="index.php?controller=accessory&action=list">List accessory product</a>
        ...
        <div class="form-group">
            ...
            <button type="submit" class="btn btn-primary" name="add_accessory">Adding</button>
        </form>
        <div class="display_result my-3">
            <?php
            if(isset($success) && in_array('add_success', $success)){
                echo '<p style="color:green;">accessory added successfully!</p>';
