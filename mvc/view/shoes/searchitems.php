...
<head>
    ...
    <title>Listing shoes</title>
</head>
<body>
    <div class="container d-flex justify-content-end my-4">
        <form action="" method="GET" class="form-inline">
                <div class="input-group">
                    <input type="hidden" name="controller" value="shoes">
...
<div class="container d-flex flex-column justify-content-center my-4">
    <a href="index.php?controller=shoes&action=add" class="d-flex justify-content-end my-4" >Adding new shoes</a>
