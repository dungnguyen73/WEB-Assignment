...
<div class="container-fluid">
    <div class="title my-4">
        <h4> <?php 
        if($searchQuery==''){
            $searchQueryprint = 'Lifestyle';
        }
        else{
            $searchQueryprint = $searchQuery;
        }
        
        // $totalProduct = count($search_result);
        echo ucwords($searchQueryprint)." (".$totalProduct .")";
        // set-up for pagination
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                for ($page = 1; $page <= $totalPages; $page++) {
                    ...
                    echo '<li class="page-item ' . $isActive . '"><a class="page-link" href="?controller=shoes&action=public_search&search_query=' . $searchQuery . '&page=' . $page . '">' . $page . '</a></li>';
                }
                ?>
            </ul>
        </nav>
