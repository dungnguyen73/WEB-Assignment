...
<head>
    ...
    <title>Adding clothing</title>
</head>
<body>
    <div class="container-fluid" id="clothing-container">
        <h3>Add new clothing</h3>
        <a href="index.php?controller=clothing&action=list">List clothing product</a>
        ...
        <div class="form-group">
            ...
            <button type="submit" class="btn btn-primary" name="add_clothing">Adding</button>
        </form>
        <div class="display_result my-3">
            <?php
            if(isset($success) && in_array('add_success', $success)){
                echo '<p style="color:green;">Clothing added successfully!</p>';
