    ...
    <div class="row">
        <div class="col-lg-3 col-md-12" id="category">
            <div class="d-flex flex-lg-column">
                <a href="index_public.php?controller=clothing&action=public_search&search_query=tops" class = "text-dark no-underline mr-3 mb-lg-3">Tops</a>
                <a href="index_public.php?controller=clothing&action=public_search&search_query=short" class = "text-dark no-underline mr-3 mb-lg-3">Shorts</a>
                <a href="index_public.php?controller=clothing&action=public_search&search_query=hoodie" class = "text-dark no-underline mr-3 mb-lg-3">Hoodies</a>
                <a href="index_public.php?controller=clothing&action=public_search&search_query=pants" class = "text-dark no-underline mr-3 mb-lg-3">Pants</a>
                <a href="index_public.php?controller=clothing&action=public_search&search_query=jacket" class = "text-dark no-underline mr-3 mb-lg-3">Jackets</a>
                <a href="index_public.php?controller=clothing&action=public_search&search_query=socks" class = "text-dark no-underline mr-3 mb-lg-3">Socks</a>
            </div>
            <hr class ="d-lg-none">
        </div>
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                for ($page = 1; $page <= $totalPages; $page++) {
                    ...
                    echo '<li class="page-item ' . $isActive . '"><a class="page-link" href="?controller=clothing&action=public_search&search_query=' . $searchQuery . '&page=' . $page . '">' . $page . '</a></li>';
                }
                ?>
            </ul>
        </nav>
