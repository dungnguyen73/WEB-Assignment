        ...
        <tbody>
            ...
            <tr>
                ...
                <td class = "d-flex">
                    ...
                    <a type='button'class="btn btn-danger mx-2" onclick="return confirm('Confirm deleting <?php echo $value['product_name'] ?>?')" href="index.php?controller=accessory&action=delete&id=<?php echo $value['id']; ?>" title="Delete">Delete</a>
                </td>
            </tr>
            <?php
            }
