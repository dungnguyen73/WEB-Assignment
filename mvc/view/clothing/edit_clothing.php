...
<head>
    ...
    <title>Edit clothing information</title>
</head>
<body>
    <!-- <?php echo "<pre>"; print_r($dataId) ?> -->
    <div class="container-fluid" id="edit-clothing-container">
        <h3>Edit clothing</h3>
        <a href="index.php?controller=clothing&action=list" class="d-flex justify-content-end my-4" >Back to clothing list </a>
        ...
        <form action="" method="POST" class="form">
            ...
            <button type="submit" class="btn btn-primary" name='clothingupdateinfor'>Finish editing</button>
        </form>
    </div>
